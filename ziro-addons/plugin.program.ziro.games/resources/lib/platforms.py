...
_add(PlatformDef("gb", "Game Boy", "GB", "Nintendo", 40, (".gb", ".zip", ".7z"), "retroarch_gb", "emulator_retroarch", "RetroArch", '-L "{core_path}" "{rom_path}"', "retroarch.exe", "gambatte_libretro.dll"))
_add(PlatformDef("gbc", "Game Boy Color", "GBC", "Nintendo", 50, (".gbc", ".zip", ".7z"), "retroarch_gbc", "emulator_retroarch", "RetroArch", '-L "{core_path}" "{rom_path}"', "retroarch.exe", "gambatte_libretro.dll"))
